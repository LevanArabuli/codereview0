 ...
 *
 * Unlike the two-pass approach (buildPrompt + buildDeepPrompt), this prompt lets
 * Claude organically read the diff, then explore the codebase to find issues
 * invisible from the diff alone -- all in one pass.
 *
